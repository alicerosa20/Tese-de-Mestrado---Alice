...
% \begin{figure}[!htb]
% 	\centering
% 	\subfigure[Red Channel]{\label{fig:red} 		\includegraphics[width=0.45\textwidth]{./Images/red.jpg}} \qquad
% 	\subfigure[Green Channel]{\label{fig:green}
% 		\includegraphics[width=0.45\textwidth]{./Images/green.jpg}}
% 	\caption[Intensity histogram of red (a) and green channel (b) of microscopic image from the dataset.]{Intensity Histogram of red and green channel of microscopic image from the dataset.}
% 	\label{fig:histogram}
% \end{figure}
...
% \begin{figure}[!htb]
% 	\centering
% 	\subfigure[Red Channel]{\label{fig:red} 		\includegraphics[width=0.45\textwidth]{./Images/red_pre.png}} \qquad
% 	\subfigure[Green Channel]{\label{fig:green}
% 		\includegraphics[width=0.45\textwidth]{./Images/green_pre.png}}
% 	\caption[Intensity histogram of red (a) and green channel (b) of microscopic image after percentile contrast stretching.]{Intensity histogram of red (a) and green channel (b) of microscopic image after percentile contrast stretching.}
% 	\label{fig:histogram_pre}
% \end{figure}
...
\begin{table}[!htb]
\centering
\caption{Average metric values after testing the 3D U-Net model with two microscopic images for a model trained with the original microscopic images (U-Net) and with the pre-processed microscopic images (U-Net + Pre)}
...
\begin{table}[!htb]
\centering
\caption{Average metric values obtained from testing the 3 class unsupervised CycleGAN model with two microscopic images}
