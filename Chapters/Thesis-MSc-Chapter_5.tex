...
%Shown in Figure \ref{fig:dataset} are: the original test crops in (a) and (e), designated $I^{orig}_1$ and $I^{orig}_2$, respectively; the crops obtained by applying the pre-processing method described in the previous Section in (b) and (f), designated $I^{Pre}_1$ and $I^{Pre}_2$, respectively; the ground truth segmentation masks for the models with 2 output channels in (c) and (g), denoted $I^{gt}_{21}$ and $I^{gt}_{22}$, respectively; and the ground truth segmentation masks for the models with 3 output channels in (d) and (h), denoted $I^{gt}_{31}$ and $I^{gt}_{32}$, respectively.
...
In this subsection the results obtained by training and testing the \ac{3D} U-Net model are presented and discussed.
...
\begin{table}[!htb]
\centering
\caption{Average metric values after testing the \ac{3D} U-Net model on two microscopic images for a model trained with the original microscopic images (U-Net) and with the pre-processed microscopic images (U-Net + Pre).}
...
\centering
\subfigure[]{\includegraphics[width=4.5cm]{Images/2-mask-crop5.jpg}}\hfil
...
\subfigure[]{\includegraphics[width=4.5cm]{Images/2-mask-crop7.jpg}}\hfil 
...
\cline{2-7}
                                              & DC Nuclei & DC Golgi & Precision Nuclei & Precision Golgi & Recall Nuclei & Recall Golgi \\ \hline
\multicolumn{1}{|c|}{CycleGAN (Supervised)}   & 0.7612   & \textbf{0.6545}  & 0.6894           & \textbf{0.6004}       & 0.8528        & 0.7450     \\ \hline
\multicolumn{1}{|c|}{CycleGAN (Unsupervised)} & \textbf{0.7664}    & 0.6427   & \textbf{0.6903}           & 0.5468          & \textbf{0.8629}        & \textbf{0.8038}       \\ \hline
\end{tabular}%
}
\end{table}
...
\begin{table}[!htb]
  ...
  \resizebox{\columnwidth}{!}{%
  \begin{tabular}{l|cc|cc|c|cc|cc|c|cc|cc|c|}
    \cline{2-16}
                                   & \multicolumn{2}{c|}{DC Nuclei}                         & \multicolumn{2}{c|}{DC Golgi}                          & DC Pair         & \multicolumn{2}{!{\vrule width 3pt}c|}{Precision Nuclei}                  & \multicolumn{2}{c|}{Precision Golgi}                   & Precision Pair  & \multicolumn{2}{!{\vrule width 3pt}c|}{Recall Nuclei}                     & \multicolumn{2}{c|}{Recall Golgi}                      & Recall Pair     \\ \cline{2-16} 
                                   & \multicolumn{1}{c|}{2 class}         & 3 class         & \multicolumn{1}{c|}{2 class}         & 3 class         & -               & \multicolumn{1}{!{\vrule width 3pt}c|}{2 class}         & 3 class         & \multicolumn{1}{c|}{2 class}         & 3 class         & -               & \multicolumn{1}{!{\vrule width 3pt}c|}{2 class}         & 3 class         & \multicolumn{1}{c|}{2 class}         & 3 class         & -               \\ \hline
    \multicolumn{1}{|l|}{3D U-Net} & \multicolumn{1}{c|}{\textbf{0.7775}} & \textbf{0.7916} & \multicolumn{1}{c|}{\textbf{0.6938}} & \textbf{0.6752} & \textbf{0.7601} & \multicolumn{1}{!{\vrule width 3pt}c|}{\textbf{0.7067}} & \textbf{0.7589} & \multicolumn{1}{c|}{0.6500}          & 0.5935          & \textbf{0.6941} & \multicolumn{1}{!{\vrule width 3pt}c|}{0.8692}          & \textbf{0.8278} & \multicolumn{1}{c|}{0.7683}          & \textbf{0.8206} & \textbf{0.8403} \\ \hline
    \multicolumn{1}{|l|}{Vox2Vox}  & \multicolumn{1}{c|}{0.7539}          & 0.7464          & \multicolumn{1}{c|}{0.6883}          & 0.6720          & 0.7198          & \multicolumn{1}{!{\vrule width 3pt}c|}{0.6529}          & 0.7170          & \multicolumn{1}{c|}{\textbf{0.7078}} & \textbf{0.6596} & 0.6763          & \multicolumn{1}{!{\vrule width 3pt}c|}{\textbf{0.8933}} & 0.7784          & \multicolumn{1}{c|}{0.6917}          & 0.7204          & 0.7721          \\ \hline
    \multicolumn{1}{|l|}{CycleGAN} & \multicolumn{1}{c|}{0.7664}          & 0.7261          & \multicolumn{1}{c|}{0.6427}          & 0.5942          & 0.6999          & \multicolumn{1}{!{\vrule width 3pt}c|}{0.6903}          & 0.7174          & \multicolumn{1}{c|}{0.5468}          & 0.5874          & 0.6711          & \multicolumn{1}{!{\vrule width 3pt}c|}{0.8629}          & 0.7366          & \multicolumn{1}{c|}{\textbf{0.8038}} & 0.6133          & 0.7314          \\ \hline
    \end{tabular}%
  }
  \end{table}
