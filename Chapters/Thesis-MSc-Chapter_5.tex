...
\begin{table}[!htb]
  ...
  \cline{2-16}
                                 & \multicolumn{2}{c|}{DC Nuclei}                         & \multicolumn{2}{c|}{DC Golgi}                          & DC Pair         & \multicolumn{2}{c|}{Precision Nuclei}                  & \multicolumn{2}{c|}{Precision Golgi}                   & Precision Pair  & \multicolumn{2}{c|}{Recall Nuclei}                     & \multicolumn{2}{c|}{Recall Golgi}                      & Recall Pair     \\ \cline{2-16} 
                                 & \multicolumn{1}{c|}{2 class}         & 3 class         & \multicolumn{1}{c|}{2 class}         & 3 class         & -               & \multicolumn{1}{c|}{2 class}         & 3 class         & \multicolumn{1}{c|}{2 class}         & 3 class         & -               & \multicolumn{1}{c|}{2 class}         & 3 class         & \multicolumn{1}{c|}{2 class}         & 3 class         & -               \\ \hline
  \multicolumn{1}{|l|}{3D U-Net} & \multicolumn{1}{c|}{\textbf{0.7775}} & \textbf{0.7916} & \multicolumn{1}{c|}{\textbf{0.6938}} & \textbf{0.6752} & \textbf{0.7601} & \multicolumn{1}{c|}{\textbf{0.7067}} & \textbf{0.7589} & \multicolumn{1}{c|}{0.6500}          & 0.5935          & \textbf{0.6941} & \multicolumn{1}{c|}{0.8692}          & \textbf{0.8278} & \multicolumn{1}{c|}{0.7683}          & \textbf{0.8206} & \textbf{0.8403} \\ \hline
  \multicolumn{1}{|l|}{Vox2Vox}  & \multicolumn{1}{c|}{0.7539}          & 0.7464          & \multicolumn{1}{c|}{0.6883}          & 0.6720          & 0.7198          & \multicolumn{1}{c|}{0.6529}          & 0.7170          & \multicolumn{1}{c|}{\textbf{0.7078}} & \textbf{0.6596} & 0.6763          & \multicolumn{1}{c|}{\textbf{0.8933}} & 0.7784          & \multicolumn{1}{c|}{0.6917}          & 0.7204          & 0.7721          \\ \hline
  \multicolumn{1}{|l|}{CycleGAN} & \multicolumn{1}{c|}{0.7664}          & 0.7261          & \multicolumn{1}{c|}{0.6427}          & 0.5942          & 0.6999          & \multicolumn{1}{c|}{0.6903}          & 0.7174          & \multicolumn{1}{c|}{0.5468}          & 0.5874          & 0.6711          & \multicolumn{1}{c|}{0.8629}          & 0.7366          & \multicolumn{1}{c|}{\textbf{0.8038}} & 0.6133          & 0.7314          \\ \hline
  \end{tabular}%
  }
  \end{table}
